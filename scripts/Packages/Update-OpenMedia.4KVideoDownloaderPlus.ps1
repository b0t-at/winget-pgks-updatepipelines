...
$exactversionPattern = "($($BigVersion.Replace(".","\."))\.\d+)"
$versions = $WebsiteContent | Select-String -Pattern $exactversionPattern -AllMatches | ForEach-Object { $_.Matches } | ForEach-Object { $_.Groups[1].Value }
