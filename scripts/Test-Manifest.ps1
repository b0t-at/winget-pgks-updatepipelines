...
if (-Not [String]::IsNullOrWhiteSpace($Manifest)) {
    ...
    $job = Start-Job -ScriptBlock { & winget install -m "ManifestDownload" --accept-package-agreements --verbose-logs --ignore-local-archive-malware-scan --dependency-source winget }
